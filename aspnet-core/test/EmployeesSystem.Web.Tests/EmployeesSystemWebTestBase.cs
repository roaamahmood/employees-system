...
{
    public abstract class EmployeesSystemWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static EmployeesSystemWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(EmployeesSystemWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<EmployeesSystemDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<EmployeesSystemDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<EmployeesSystemDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<EmployeesSystemDbContext, Task<T>> func)
        {
            T result;
